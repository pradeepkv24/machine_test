    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{ route('delivery_home') }}" class="nav-link {{ Request::routeIs('delivery_home') ? 'active' : ''  }}">
          ...
          <li class="nav-item">
            <a href="{{ route('delivery_my_order') }}" class="nav-link {{ Request::routeIs('delivery_my_order') ? 'active' : ''  }}">
